...
public class Paging {
	...
	private int pageSize = 10; // 화면에 보여질 게시글의 개수를 지정
	private int count = 0; // 전체 글의 갯수를 저장하는 변수
	private int number = 0; // 페이지 넘버링 변수
	private String pageNum; // 보여줄 페이지넘버
	...
	public void pageCaculator() {
		if (count > 0) {
			// 전체글의 숫자가 페이지사이즈(10)으로 나눌때 나머지가 있으면 +1
